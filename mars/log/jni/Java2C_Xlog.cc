...
DEFINE_FIND_CLASS(KXlog, "com/tencent/mars/xlogjojo/Xlog")
...
JNIEXPORT void JNICALL Java_com_tencent_mars_xlogjojo_Xlog_appenderOpen
...
JNIEXPORT void JNICALL Java_com_tencent_mars_xlogjojo_Xlog_appenderClose(JNIEnv *env, jobject) {
	appender_close();
}

JNIEXPORT void JNICALL Java_com_tencent_mars_xlogjojo_Xlog_appenderFlush(JNIEnv *env, jobject, jboolean _is_sync) {
	if (_is_sync) {
		appender_flush_sync();
	} else {
		appender_flush();
...
DEFINE_FIND_STATIC_METHOD(KXlog_logWrite, KXlog, "logWrite", "(Lcom/tencent/mars/xlogjojo/Xlog$XLoggerInfo;Ljava/lang/String;)V")
JNIEXPORT void JNICALL Java_com_tencent_mars_xlogjojo_Xlog_logWrite
...
JNIEXPORT void JNICALL Java_com_tencent_mars_xlogjojo_Xlog_logWrite2
...
JNIEXPORT jint JNICALL Java_com_tencent_mars_xlogjojo_Xlog_getLogLevel
  (JNIEnv *, jobject) {
	return xlogger_Level();
}

//DEFINE_FIND_STATIC_METHOD(KXlog_setLogLevel, KXlog, "setLogLevel", "(I)V")
JNIEXPORT void JNICALL Java_com_tencent_mars_xlogjojo_Xlog_setLogLevel
...
JNIEXPORT void JNICALL Java_com_tencent_mars_xlogjojo_Xlog_setAppenderMode
...
JNIEXPORT void JNICALL Java_com_tencent_mars_xlogjojo_Xlog_setConsoleLogOpen
...
JNIEXPORT void JNICALL Java_com_tencent_mars_xlogjojo_Xlog_setMaxFileSize
...
JNIEXPORT void JNICALL Java_com_tencent_mars_xlogjojo_Xlog_setMaxAliveTime
